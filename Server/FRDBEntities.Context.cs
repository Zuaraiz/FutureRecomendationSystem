...
namespace Server
{
    ...
    public partial class FRDBEntities : DbContext
    {
        ...
        public virtual ObjectResult<AddUserRecomendation_Result> AddUserRecomendation(string email, Nullable<int> major)
        {
            var emailParameter = email != null ?
                new ObjectParameter("email", email) :
                new ObjectParameter("email", typeof(string));
        ...
        public virtual ObjectResult<UserAddInterests_Result> UserAddInterests(string email, Nullable<int> interest, Nullable<int> rating)
        {
            var emailParameter = email != null ?
                new ObjectParameter("email", email) :
                new ObjectParameter("email", typeof(string));
        ...
        public virtual ObjectResult<UserAddSkills_Result> UserAddSkills(string email, Nullable<int> skill, Nullable<int> rating)
        {
            var emailParameter = email != null ?
                new ObjectParameter("email", email) :
                new ObjectParameter("email", typeof(string));
        ...
        public virtual int UserSignUp(string email, string password, string firstName, string secondName, Nullable<decimal> percentage, Nullable<decimal> annualBudget, Nullable<int> location, Nullable<int> qualification)
        {
            var emailParameter = email != null ?
                new ObjectParameter("email", email) :
                new ObjectParameter("email", typeof(string));
