...
namespace FutureRecommenderApp
{
    ...
    public class AddSkill : Activity
    {
        ...
        private async Task<string> getSkills()
        {
            ...
            var result = await client.PostAsync("http://futurerecommend.azurewebsites.net/api/get/skills", content).ConfigureAwait(false);
