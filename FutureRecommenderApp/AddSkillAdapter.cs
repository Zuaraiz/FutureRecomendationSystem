...
namespace FutureRecommenderApp
{
    ...
    class AddSkillAdapter: BaseAdapter<GetAllSkill_Result>
    {
        Activity context;
        ...
        public AddSkillAdapter(Activity _context, List<GetAllSkill_Result> _list,String email) : base()
        {
            this.Email = email;
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            Button v= view.FindViewById<Button>(Resource.Id._add_);
                ...
                try
                {
                    Task<string> task = Addskill(Email, item.id, Selected);
